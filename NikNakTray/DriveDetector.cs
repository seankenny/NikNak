...
namespace Dolinay
{
    ...
    class DriveDetector : IDisposable
    {
        ...
        /// </summary>
        public event DriveDetectorEventHandler IPhoneAttached;
            ...
            if (m.Msg == WM_DEVICECHANGE)
            {
                ...
                switch (m.WParam.ToInt32())
                {
                    case DBT_IPHONE_HANDLE:
                        IPhoneAttached(this, new DriveDetectorEventArgs());
                        break;
                    //
        ...
        private ArrayList getFriendlyNameList()
        {
            ...
            foreach (ManagementObject devices in searcher.Get())
            {
                ...
                if (nameProperty != null && nameProperty.ToString().ToLower().Contains("usb"))
                {
